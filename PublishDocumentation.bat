...
SET BRIDGELINK_DOCUMENTATION_VERSION=5.0
...
SET BARLIST_DOCUMENTATION_VERSION=5.2
...
copy \ARP\PGSuper\TxDOTAgent\Documentation\TOGA\Toga.dm %DOC_TARGET%\TOGA\%PGSUPER_DOCUMENTATION_VERSION%\Toga.dm.html
copy \ARP\PGSuper\TxDOTAgent\Documentation\TOGA\doc\html\* %DOC_TARGET%\TOGA\%PGSUPER_DOCUMENTATION_VERSION%\


rmdir /S /Q %DOC_TARGET%\TxCADExport\%PGSUPER_DOCUMENTATION_VERSION%\
mkdir %DOC_TARGET%\TxCADExport\%PGSUPER_DOCUMENTATION_VERSION%\
copy \ARP\PGSuper\TxDOTAgent\Documentation\TxCADExport\TxCADExport.dm %DOC_TARGET%\TxCADExport\%PGSUPER_DOCUMENTATION_VERSION%\TxCADExport.dm.html
copy \ARP\PGSuper\TxDOTAgent\Documentation\TxCADExport\doc\html\* %DOC_TARGET%\TxCADExport\%PGSUPER_DOCUMENTATION_VERSION%\
